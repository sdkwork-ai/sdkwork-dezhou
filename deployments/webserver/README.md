...
Module `sdkwork-dezhou` · runtime code `dezhou` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `dezhou-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `dezhou-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `dezhou-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `dezhou-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `dezhou.sdkwork.com` | 443 ssl + 80 |
