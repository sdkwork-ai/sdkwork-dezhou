...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `dezhou-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `dezhou-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `dezhou-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `dezhou.sdkwork.com` | 443 ssl + 80 |
