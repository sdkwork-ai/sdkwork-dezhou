# sdkwork-dezhou Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-dezhou` |
| `runtimeCode` | `dezhou` |
| Config root | `/etc/sdkwork/dezhou/` |
| Runtime TOML | `/etc/sdkwork/dezhou/config.toml` |
| Secrets | `/etc/sdkwork/dezhou/secrets/` |
| Override | `SDKWORK_DEZHOU_CONFIG_FILE` |
