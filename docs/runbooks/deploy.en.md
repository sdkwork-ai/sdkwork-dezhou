# Runbook — sdkwork-dezhou deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-dezhou-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-dezhou/bundle`, loads the image, starts
